...
export default function QuickActionButton({ className }: QuickActionButtonProps) {
  ...
  return (
    <>
      ...
      {/* Action Menu */}
      <div className={cn("fixed bottom-36 right-6 z-50 flex flex-col-reverse gap-3", className)}>
        {isOpen && (
          <>
      ...
      <button
        ...
        className={cn(
          "fixed bottom-24 right-6 z-50 w-14 h-14 bg-gradient-to-r from-accent-primary to-accent-secondary rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-110 flex items-center justify-center group",
          className
        )}
