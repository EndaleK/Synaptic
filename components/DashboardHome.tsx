...
const primaryModes = [
  ...
  { id: "course-setup", name: "Course Setup", icon: Plus, description: "Add a new course", href: "/dashboard/course-setup", color: "from-[#7B3FF2] to-[#6B2FE2]", bgColor: "bg-violet-500/10", textColor: "text-[#7B3FF2] dark:text-purple-400" },
]
...
const secondaryModes = [
  ...
  { id: "podcast", name: "Podcast", icon: Mic, description: "Listen & learn", color: "from-violet-500 to-violet-600", bgColor: "bg-violet-500/10", textColor: "text-[#7B3FF2] dark:text-purple-400" },
...
export default function DashboardHome({ onModeSelect }: DashboardHomeProps) {
  ...
  return (
    <div className="min-h-full bg-hero-dawn font-body relative overflow-hidden">
      {/* Atmospheric background - matching landing page */}
      <div className="fixed inset-0 pointer-events-none">
        {/* Animated gradient orbs with glow halos - same as landing hero */}
        ...
        <section className="mb-12">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            ...
            <div className="space-y-3 animate-hero-reveal">
              <p className="text-sm font-semibold tracking-[0.15em] text-[#7B3FF2] dark:text-purple-400 uppercase font-body">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-display font-extrabold tracking-tight leading-[1.1]">
                ...
                <span className="bg-gradient-to-r from-[#7B3FF2] via-[#E91E8C] to-[#FF6B35] bg-clip-text text-transparent animate-gradient-border bg-[length:200%_200%]">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                {actionState.type === 'loading' ? (
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-[#7B3FF2] to-[#6B2FE2] rounded-xl hover:from-[#6B2FE2] hover:to-[#5B1FD2] transition-all shadow-lg shadow-[#7B3FF2]/25 hover:shadow-[#7B3FF2]/40 hover:scale-[1.02]"
                  >
            ...
            <div className="p-5 sm:p-6 rounded-2xl bg-white/80 dark:bg-white/[0.03] backdrop-blur-xl border border-white/50 dark:border-white/10 card-level-1 card-glow">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-xl bg-[#7B3FF2]/10 dark:bg-[#7B3FF2]/15 flex items-center justify-center">
                    <BookMarked className="w-6 h-6 text-[#7B3FF2] dark:text-purple-400" />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3 py-1.5 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-[#7B3FF2] dark:hover:text-purple-400 hover:bg-[#7B3FF2]/10 dark:hover:bg-[#7B3FF2]/15 rounded-lg transition-colors"
                  >
                    View All
                  </button>
                  <button
                    onClick={() => setShowStudyPlanWizard(true)}
                    className="px-4 py-2 text-sm font-semibold text-white bg-gradient-to-r from-[#7B3FF2] to-[#6B2FE2] hover:from-[#6B2FE2] hover:to-[#5B1FD2] rounded-xl shadow-lg shadow-[#7B3FF2]/25 hover:shadow-[#7B3FF2]/40 transition-all flex items-center gap-2"
                  >
        ...
        <section className="mb-12 animate-hero-reveal stagger-5">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#7B3FF2]/10 dark:bg-[#7B3FF2]/15 hover:bg-violet-100 dark:hover:bg-violet-500/20 transition-colors"
            >
              <Sparkles className="w-3.5 h-3.5 text-[#7B3FF2]" />
              <span className="text-xs font-semibold text-[#7B3FF2] dark:text-purple-400">
                {showMoreTools ? 'Show less' : 'More tools'}
              </span>
              <ChevronDown className={`w-3.5 h-3.5 text-[#7B3FF2] transition-transform duration-300 ${showMoreTools ? 'rotate-180' : ''}`} />
            </button>
          </div>
                ...
                {secondaryModes.map((mode, index) => {
                  ...
                  return (
                    <button
                      key={mode.id}
                      onClick={() => handleModeClick(mode)}
                      className="group flex items-center gap-3 p-3 rounded-xl bg-white/70 dark:bg-white/[0.02] hover:bg-white dark:hover:bg-white/[0.05] border border-gray-100 dark:border-white/10 hover:border-[#7B3FF2]/30 dark:hover:border-[#7B3FF2]/30 transition-all duration-300 card-glow"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5">
            ...
            <div className="p-5 sm:p-6 rounded-2xl bg-white/80 dark:bg-white/[0.03] backdrop-blur-xl border border-white/50 dark:border-white/10 card-level-1 card-glow">
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#7B3FF2] to-[#6B2FE2] flex items-center justify-center shadow-lg shadow-violet-500/30">
                    <Clock className="w-5 h-5 text-white" />
                  </div>
                ...
                <button
                  onClick={() => router.push('/dashboard/documents')}
                  className="text-xs font-semibold text-[#7B3FF2] dark:text-purple-400 hover:text-violet-700 dark:hover:text-violet-300 flex items-center gap-1.5 group px-3 py-1.5 rounded-lg hover:bg-[#7B3FF2]/10 dark:hover:bg-[#7B3FF2]/15 transition-all"
                >
              ...
              {recentActivity.length > 0 ? (
                    ...
                    return (
                      ...
                      >
                        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-violet-100 to-pink-100 dark:from-violet-500/20 dark:to-pink-500/20 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                          <Icon className="w-5 h-5 text-[#7B3FF2] dark:text-purple-400" />
                        </div>
                ...
                <div className="py-10 text-center">
                  <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-violet-100 to-purple-100 dark:from-violet-500/10 dark:to-purple-500/10 flex items-center justify-center">
                    <GraduationCap className="w-8 h-8 text-violet-400 dark:text-[#7B3FF2]" />
                  </div>
                  ...
                  <button
                    onClick={() => router.push('/dashboard/course-setup')}
                    className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-gradient-to-r from-[#7B3FF2] to-[#6B2FE2] rounded-xl hover:from-[#6B2FE2] hover:to-[#5B1FD2] transition-all shadow-lg shadow-[#7B3FF2]/25"
                  >
                    <Plus className="w-4 h-4" />
                    Set Up Your First Course
                  </button>
              ...
              {recentActivity.length > 4 && (
                <button
                  ...
                  className="w-full text-center text-xs font-semibold text-gray-500 dark:text-gray-400 hover:text-[#7B3FF2] dark:hover:text-purple-400 py-2 mt-3 flex items-center justify-center gap-1.5 transition-colors rounded-lg hover:bg-gray-50 dark:hover:bg-white/5"
                >
