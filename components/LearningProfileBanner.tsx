...
import { Brain, Eye, Headphones, Hand, BookOpen, Sparkles, TrendingUp, RefreshCw, ChevronDown, ChevronUp } from "lucide-react"
...
export default function LearningProfileBanner({ onTakeAssessment }: LearningProfileBannerProps) {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('learningProfileBanner_expanded')
    if (saved !== null) {
  ...
  const toggleExpanded = () => {
    ...
    localStorage.setItem('learningProfileBanner_expanded', String(newState))
  }
  ...
  if (!hasCompletedAssessment || !learningStyle) {
    return (
      <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl border border-purple-200 dark:border-purple-800 shadow-sm overflow-hidden">
        {/* Header - Always Visible */}
        <button
          onClick={toggleExpanded}
          className="w-full p-6 flex items-start gap-4 hover:bg-purple-100/50 dark:hover:bg-purple-900/10 transition-colors"
        >
          {/* Icon */}
          ...
          <div className="flex-1 min-w-0 text-left">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-sm mt-1">
              Take our 2-minute assessment to unlock personalized learning experiences
            </p>
          </div>
        ...
        {/* Expanded Content */}
        {isExpanded && (
          <div className="px-6 pb-6 border-t border-purple-200 dark:border-purple-800">
            <div className="pt-4">
              {/* Learning Styles */}
              <div className="mb-4">
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-2xl border border-blue-200 dark:border-blue-800 shadow-sm overflow-hidden">
      {/* Header - Always Visible */}
      <button
        onClick={toggleExpanded}
        className="w-full p-6 flex items-start gap-4 hover:bg-blue-100/50 dark:hover:bg-blue-900/10 transition-colors"
      >
        {/* Icon */}
