-- Migration: Add chat_message tracking support (FIXED VERSION)
-- Created: 2025-11-14
...
-- Note: The usage_tracking table already exists with flexible action_type column
...
BEGIN
  ...
  -- Check if action_type column exists (accept TEXT or VARCHAR types)
  IF NOT EXISTS (
    ...
    RAISE EXCEPTION 'usage_tracking.action_type column must be TEXT or VARCHAR type!';
  END IF;
